...
# CONFIGURATION
# ==========================================
BOT_TOKEN         = os.environ.get("BOT_TOKEN", "8628089455:AAGEIZ9KCL_1_aoIhr_J3ImcaQO3ubBak7o")
ADMIN_TELEGRAM_ID = int(os.environ.get("ADMIN_TELEGRAM_ID", "6106058051"))
...
def main():
    ...
    # Render pe WEBHOOK — conflict error fix
    # Locally (RENDER_EXTERNAL_URL nahi hoga) polling chalegi
    render_url = os.environ.get("RENDER_EXTERNAL_URL", "").rstrip("/")

    if render_url:
        port = int(os.environ.get("PORT", 10000))
        # Webhook path mein token use karo taaki sirf Telegram hi POST kar sake
