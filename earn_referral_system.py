...
# ==========================================
# Naya Bot Token
BOT_TOKEN = "8628089455:AAGEIZ9KCL_1_aoIhr_J3ImcaQO3ubBak7o"
...
def admin_withdraw_action():
    ...
    if action == 'Approve':
        ...
        text = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"💰 Amount: <b>{amount} Coins</b>\n"
            f"🔄 Refunded back to your wallet\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
...
async def check_force_join(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if u and u['is_blocked']:
        if update.message: await update.message.reply_text("🚫 <b>Access Denied!</b>\n\n━━━━━━━━━━━━━━━━━━━━\nYou have been <b>blocked</b> from using this bot.\nContact support if you believe this is an error.\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML')
        elif update.callback_query: await update.callback_query.answer("🚫 You are blocked from this bot.", show_alert=True)
    ...
    if not u:
        ...
        if args and args[0].isdigit():
            ...
            if referrer_id != user.id:
                ...
                try:
                    await context.bot.send_message(chat_id=referrer_id, text=f"🎉 <b>New Referral Earned!</b>\n\n━━━━━━━━━━━━━━━━━━━━\n💰 <b>+{reward} Coins</b> Added to your wallet!\n👤 A new user joined using your link!\n━━━━━━━━━━━━━━━━━━━━\n📢 Keep sharing to earn even more!", parse_mode='HTML')
                except: pass
...
async def process_withdrawal(update, user_id, amount, method, details):
    ...
    await update.message.reply_text("✅ <b>Withdrawal Request Submitted!</b>\n\n━━━━━━━━━━━━━━━━━━━━\n📋 Your request is <b>under review</b>\n⏳ Admin will process it shortly\n🔔 You'll be notified once approved\n━━━━━━━━━━━━━━━━━━━━\nThank you for your patience! 🙏", parse_mode='HTML', reply_markup=get_main_keyboard())
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "❌ Cancel":
        if user_id in USER_STATES: 
            del USER_STATES[user_id]
        await update.message.reply_text("❌ <b>Action Cancelled</b>\n\nYou've been returned to the main menu.", parse_mode='HTML', reply_markup=get_main_keyboard())
        return
    ...
    if user_id in USER_STATES:
        ...
        if state['step'] == 'amount':
            try:
                ...
                if amount < min_w:
                    await update.message.reply_text(f"❌ <b>Amount Too Low!</b>\n\n━━━━━━━━━━━━━━━━━━━━\n🎯 Minimum withdrawal: <b>{min_w} coins</b>\nPlease enter a higher amount.\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML')
                    del USER_STATES[user_id]
                    return
                if amount > user_data['balance']:
                    await update.message.reply_text("❌ <b>Insufficient Balance!</b>\n\n━━━━━━━━━━━━━━━━━━━━\nYou don't have enough coins\nfor this withdrawal amount.\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML')
                    del USER_STATES[user_id]
                    return
                ...
                await update.message.reply_text("💳 <b>Select Payment Method</b>\n\n━━━━━━━━━━━━━━━━━━━━\nChoose how you'd like to\nreceive your payment:\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML', reply_markup=method_kb)
            except ValueError:
            ...
            if text == "🏦 Bank Transfer":
                ...
                await update.message.reply_text("🏦 <b>Bank Transfer</b>\n\n━━━━━━━━━━━━━━━━━━━━\n📝 Step 1 of 4\nEnter your <b>Bank Name:</b>\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML', reply_markup=ReplyKeyboardMarkup([["❌ Cancel"]], resize_keyboard=True))
            
            elif text == "📱 UPI":
                USER_STATES[user_id]['method'] = 'UPI'
                USER_STATES[user_id]['step'] = 'upi_id'
                await update.message.reply_text("📱 <b>UPI Payment</b>\n\n━━━━━━━━━━━━━━━━━━━━\nEnter your <b>UPI ID:</b>\n(e.g. name@upi)\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML', reply_markup=ReplyKeyboardMarkup([["❌ Cancel"]], resize_keyboard=True))
            
            elif text == "💳 Crypto":
                USER_STATES[user_id]['method'] = 'Crypto'
                USER_STATES[user_id]['step'] = 'crypto_address'
                await update.message.reply_text("💎 <b>Crypto Payment</b>\n\n━━━━━━━━━━━━━━━━━━━━\nEnter your <b>Wallet Address</b>\n(e.g. USDT TRC20)\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML', reply_markup=ReplyKeyboardMarkup([["❌ Cancel"]], resize_keyboard=True))
            
            else:
                await update.message.reply_text("❌ <b>Invalid Selection!</b>\n\nPlease choose a method from the keyboard options.", parse_mode='HTML')
            return
            
        elif state['step'] == 'bank_name':
            USER_STATES[user_id]['bank_name'] = text
            USER_STATES[user_id]['step'] = 'bank_ac_num'
            await update.message.reply_text("🔢 <b>Step 2 of 4</b>\n\nEnter your <b>Account Number:</b>", parse_mode='HTML')
            return
            
        elif state['step'] == 'bank_ac_num':
            USER_STATES[user_id]['bank_ac_num'] = text
            USER_STATES[user_id]['step'] = 'bank_ifsc'
            await update.message.reply_text("🔠 <b>Step 3 of 4</b>\n\nEnter your <b>IFSC Code:</b>", parse_mode='HTML')
            return
            
        elif state['step'] == 'bank_ifsc':
            USER_STATES[user_id]['bank_ifsc'] = text
            USER_STATES[user_id]['step'] = 'bank_holder'
            await update.message.reply_text("👤 <b>Step 4 of 4</b>\n\nEnter <b>Account Holder Name:</b>", parse_mode='HTML')
            return
    ...
    if text == "💰 Balance":
        ...
        await update.message.reply_text(f"💰 <b>Your Wallet Balance</b>\n\n━━━━━━━━━━━━━━━━━━━━\n🪙 <b>{u['balance']} Coins</b>\n━━━━━━━━━━━━━━━━━━━━\n📢 Refer friends to earn more!", parse_mode='HTML')
        ...
        msg = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"🎁 Reward per Invite: <b>{reward} Coins</b>\n"
            f"👤 Your Total Invites: <b>{u['total_referrals']}</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━\n\n"
            f"🔗 <b>Your Referral Link:</b>\n"
            f"<code>{link}</code>\n\n"
            f"📢 Share with friends &amp; earn coins for every join!"
        )
        ...
        if u['balance'] < min_w:
            await update.message.reply_text(f"❌ <b>Insufficient Balance</b>\n\n━━━━━━━━━━━━━━━━━━━━\n💰 Your Balance: <b>{u['balance']} coins</b>\n🎯 Minimum Required: <b>{min_w} coins</b>\n━━━━━━━━━━━━━━━━━━━━\n📢 Earn more by referring friends!", parse_mode='HTML')
            return
            
        USER_STATES[user_id] = {'step': 'amount'}
        await update.message.reply_text(f"💳 <b>Withdrawal Portal</b>\n\n━━━━━━━━━━━━━━━━━━━━\n💰 Your Balance: <b>{u['balance']} coins</b>\n🎯 Minimum: <b>{min_w} coins</b>\n━━━━━━━━━━━━━━━━━━━━\nEnter the <b>AMOUNT</b> you want to withdraw:", parse_mode='HTML', reply_markup=ReplyKeyboardMarkup([["❌ Cancel"]], resize_keyboard=True))
        ...
        for i, t in enumerate(top, 1):
            ...
            msg += f"{icon} {name}\n   💰 {t['balance']} Coins | 👥 {t['total_referrals']} Refs\n"
        msg += "━━━━━━━━━━━━━━━━━━━━\n📢 Refer more to climb the ranks!"
        await update.message.reply_text(msg, parse_mode='HTML')
        ...
        msg = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"💰 Balance: <b>{u['balance']} Coins</b>\n"
            f"👥 Referrals: <b>{u['total_referrals']}</b>\n"
            f"📋 Tasks Done: <b>{tasks_done}</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━"
        )
        await update.message.reply_text(msg, parse_mode='HTML')
        ...
        msg = (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n"
            "👥 <b>Referral</b>\nShare your link &amp; earn coins for every friend who joins.\n\n"
            "📋 <b>Tasks</b>\nComplete simple tasks to earn extra coins instantly.\n\n"
            "🎁 <b>Daily Bonus</b>\nClaim free coins every 24 hours — don't miss it!\n\n"
            "💳 <b>Withdraw</b>\nReach the minimum balance, tap Withdraw &amp; follow the steps.\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "🚀 Start earning now!"
        )
        await update.message.reply_text(msg, parse_mode='HTML')
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        await context.bot.send_message(chat_id=user_id, text="🎉 <b>Welcome Aboard!</b>\n\n━━━━━━━━━━━━━━━━━━━━\n✅ You've successfully joined!\n🚀 Full access unlocked — enjoy the bot!\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML', reply_markup=get_main_keyboard())
        return
    ...
    if data.startswith("task_info_"):
        ...
        if not task:
            await query.answer("⚠️ Task not found or removed.", show_alert=True)
            return
        ...
        msg = (
            f"📋 <b>{task['title']}</b>\n\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"🪙 Reward: <b>{task['reward']} Coins</b>\n"
            f"📝 {task['description']}\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"👇 Open the link, complete the task, then tap Verify!"
        )
        markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔗 Open Task Link", url=task['link'])],[InlineKeyboardButton("✅ Verify & Claim Reward", callback_data=f"task_done_{task_id}")]
        ])
        await query.message.edit_text(msg, parse_mode='HTML', reply_markup=markup)
        ...
        if done:
            await query.answer("✅ Already completed! Reward already claimed.", show_alert=True)
            return
        ...
        await query.answer(f"🎉 Task Done! +{task['reward']} Coins Added!", show_alert=True)
        await query.message.edit_text(f"✅ <b>Task Completed!</b>\n\n━━━━━━━━━━━━━━━━━━━━\n💰 <b>+{task['reward']} Coins</b> added to your wallet!\n🔙 Go back to explore more tasks.\n━━━━━━━━━━━━━━━━━━━━", parse_mode='HTML')
