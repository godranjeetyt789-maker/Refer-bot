    ...
    if get_setting('force_join') == '1':
        ...
        if channels:
            ...
            if not_joined:
                ...
                buttons = [[InlineKeyboardButton(c['channel_name'], url=c['channel_link'])] for c in current_batch]
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        await context.bot.send_message(chat_id=user_id, text="✅ Thank you for joining! You can now use the bot.", reply_markup=get_main_keyboard(user_id))
        return
